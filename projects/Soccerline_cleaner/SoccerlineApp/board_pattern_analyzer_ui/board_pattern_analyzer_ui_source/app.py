...
try:
    from core.board_pattern_analyzer import analyze_board
except ModuleNotFoundError:
    from board_pattern_analyzer_ui.core.board_pattern_analyzer import analyze_board
...
class BoardPatternAnalyzerApp(ctk.CTk):
    ...
    def build_ui(self) -> None:
        ...
        ).grid(row=4, column=0, sticky="ew", padx=24, pady=(8, 24))
